...
- **MEASURED:** before = 8/12 clean with 4/12 faulting at this exact site; after SH116b = **10/10 clean, full V2 ladder each run** (SendAppEvent Ok), SH116b fired every run. Default path unregressed (3/3 clean Ok(0x10006), SH116b not fired). Forward hardening of flag-init, not the concluded migration gate.
- **STANDING (unchanged):** Route-B live-DM world-build = the structural gate (SH174/196/203/204). SH116b clears a real client crash on the ladder but does NOT manufacture a DataModel.
