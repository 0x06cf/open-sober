...
## SH233 (Sep 16, 2026, hermes-worker): `cargo test -p arm64jit --examples` parallel batch made genuinely GREEN — was silently failing 5 of 78 real-image guards (sh222-228/sh231/sh232) on EVERY run. Test-harness-only fix, zero production change. Doc docs/frontier-sh233-examples-batch-green-cache.md. Commit <SH233>.
