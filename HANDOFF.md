...
## SH190e (Sep 16, 2026, hermes-worker): BOTH GuiObject-family instances self-construct headlessly — PlayerGui (0x106648950) AND ScreenGui (0x106649ce0). The SH189b recon-negative is crossed. Commit <SH190ECOMMIT>. Doc docs/frontier-sh189-dm-classregistry.md (SH190e). Repro runs/capture_sh190c_member_seed.sh (gitignored log).
