...
- **SH187b (42fb965):** the constructed genuine DM (ret x0=obj+0x1f0) is now planted into the current-DM holder *0x106391908 (always, crash-free) + consumer delegate slots +0xe8/+0xf0/+0xc0 +0x38c seeded. The one bl-reachable consumer (get-or-create 0x2dbcd88 from MemStorage_bind 0x24c61e8 / nativeOnDestroyed 0x275bd04) probe is behind JIT_ROUTEB_DM_REALCTOR_CONSUMER=1 because it raw-aborts (needs 0x2dbd018 once-cell + 0x2411658 keyed lookup seeded first; recon deleg_f39b7cda). Verified: EXIT 124, 0 crashes, 'planted constructed DM into current-DM holder'.
- **NEXT (honest):** verify the constructed obj (ret x0 = obj+0x1f0) is a coherent live DM; feed it to the current-DM holder 0x106391908 / DataModelServices consumer 0x2db63f4 and observe dispatch; re-derive the post-DM content/GuiObject path against the corrected base. Prior "migration-gate" closures were built on the wrong +8 vptr and need re-derivation.
