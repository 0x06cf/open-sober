...
## SH229 (Sep 16, 2026, hermes-worker): FULL DataModel ctor drive (un-NOP'd subobject `bl 0x23f6b0c`) = MEASURED instance-base redirect, not a DM — new measurement closing the operator's "drive the full ctor" re-attack angle. +1 hermetic (sh229, arm64jit 389/0). Commit <SH229COMMIT>. Doc docs/frontier-sh229-full-dm-ctor-instancebase-redirect.md, repro runs/capture_sh229_real_ctor_full.sh. Workspace green.
