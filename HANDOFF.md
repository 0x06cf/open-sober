...
## SH140 (Sep 14, 2026, hermes-worker): login link row — "Forgot password?" + "Sign up" through the engine emitter, first shipped COMPOSITE-glyph artifact (SH79 demonstrated). Workspace green (537/0, elfjit example 42/0). Commit SH140. Doc docs/frontier-sh140-emoji-link-row.md.
