...
## SH165 (Sep 15, 2026, hermes-worker): the governor-tail dispatch now ENTERS real engine-init (DM-force) — the Route-B wall moved. Workspace green (541/0). Commit c17b3bd. Doc docs/frontier-sh165-dmforce-engine-init.md.
