...
## SH195 (Sep 16, 2026, hermes-worker): SCENE-ATTACH ABI GATE — the self-constructed PlayerGui's LIVE vtable is genuinely populated (positive), but its draw slot (vt+24) is an x1-forwarding bounce the present-walker cannot direct-dispatch. Commit 5f0e6a8. Doc docs/frontier-sh195-scene-attach-abigate.md. Workspace green (558/0); recon-v3 re-verified 24 task-driven frames / 196 pops / no json abort.
