...
## SH137 (Sep 14, 2026, hermes-worker): guarded `__vsnprintf_chk` shim (fortified vsnprintf, SH136-harden). Workspace green (536/0). Commit SH137. Extends docs/frontier-sh135-str-op-shims.md.
