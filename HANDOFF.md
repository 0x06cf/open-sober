...
## SH187 (Sep 15, 2026, hermes-worker): VPTR-BASE CORRECTION + FIRST genuine-DM ctor CONSTRUCTION headlessly. Workspace 375/0. Commit <SH187COMMIT>. Doc docs/frontier-sh187-dm-vptr-base-corrected.md, repro runs/capture_sh187_real_ctor.sh, log runs/sh187-real-ctor.txt.
