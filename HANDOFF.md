...
## SH116 (Sep 14, 2026, hermes-worker): singleton-dispatch scoped patch (SH115) + nativeInit lock-owner helper patch — the 3 soft-return sites now RESOLVE; opt-in until the deeper nativeInit gate clears. Default ladder unregressed (EXIT 0, StartLuaAppDM Ok, task frame present swap Ok(0x1)).
