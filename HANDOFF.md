...
## SH128+SH129 (Sep 14, 2026, hermes-worker): combined-frame re-drive implemented (opt-in; runtime-verification BLOCKED by the combined engine-clone flake) + login-cookie ingress ABI fully mapped (jar-init structural wall). Workspace green (522/0, elfjit example 40/0, +3 sh128 regressions). Commits 8dff7b4 (SH128) + SH129 doc + ledgers.
