...
## SH139 (Sep 14, 2026, hermes-worker): guarded raw `memcpy`/`memset` + `__memcpy_chk`/`__strncpy_chk` + `__android_log_print` ptr_ok (SH135-class, reachable-path). Workspace green (537/0). Commit SH139. Extends docs/frontier-sh135-str-op-shims.md.
