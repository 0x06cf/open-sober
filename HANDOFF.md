...
## SH207 (Sep 16, 2026, hermes-worker): RESOLVER-MAP GATE CLOSED AT FRESH SOURCE-DEPTH (bulk-registrar SOURCE 0x106dca0e90 measured EMPTY) + futex-requeue flake FIXED to green. Commit <SH207COMMIT>. Doc docs/frontier-sh207-resolver-source-empty.md. Workspace green (387/0 arm64jit incl. new sh207 test + all crates).
