...
## SH217 (Sep 16, 2026, hermes-worker): READY-TO-FIRE correction of the SH161b governor-tail mode-2 seed window (the operator's POST-SH161 "NEXT GATE"). Commit c88c7df. Doc docs/frontier-sh217-sh161b-window-corrected.md. Workspace green (arm64jit 387/0 + all crates).
