...
## SH138 (Sep 14, 2026, hermes-worker): guarded `__vsprintf_chk` shim (sprintf-family fortify, SH136-harden). Workspace green (537/0). Commit SH138. Extends docs/frontier-sh135-str-op-shims.md.
