...
## SH174 (Sep 15, 2026, hermes-worker): ROUTE-B CONE CLOSES + MIGRATION-HARNESS RUNBOOK (docs/frontier-sh174-migration-runbook.md). Workspace green (546/0, arm64jit 368). Docs-only commit — no production code change.
