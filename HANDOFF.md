...
## SH198 (Sep 16, 2026, hermes-worker): DETERMINISTIC DIAGNOSTIC for the run-variable "outside image" stop + governor MODERN blob-path REACHED. Commit <SH198COMMIT>. Doc docs/frontier-sh198-outside-image-ringbuf.md, repro runs/capture_sh198_outside_image.sh. Workspace green (560/0, +1 hermetic; arm64jit 382/0).
