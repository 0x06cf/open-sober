...
## SH191 (Sep 16, 2026, hermes-worker): PlayerGui SELF-CONSTRUCTED instance becomes a real SERVICE NODE on [dm+0x68] ([node+0x18]==0x87e), and the engine's OWN getService walker 0x105e09bc8 EXECUTES CLEANLY headlessly. Commit 7073ff4. Doc docs/frontier-sh191-service-node-getservice.md. Repro runs/capture_sh191_service_node.sh (gitignored log).
