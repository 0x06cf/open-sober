...
## SH134 (Sep 14, 2026, hermes-worker): HTTP-TRANSPORT recon + real AppBridge base URL. Workspace green (534/0, elfjit example 41/0). Commits ddd7557 (recon doc), be3bb5d (SH134). Docs docs/frontier-http-transport-recon.md, docs/frontier-sh134-baseurl.md.
