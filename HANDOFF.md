...
## SH136 (Sep 14, 2026, hermes-worker): guarded memcmp/strcasecmp/strncasecmp shims (SH135-class hardening, reachable-path). Workspace green (535/0). Commit SH136. Extends docs/frontier-sh135-str-op-shims.md.
