...
## SH221 (Sep 16, 2026, hermes-worker): resolved a STALE decoder-gap verdict + shipped a durable real-image decode-coverage pin. Commit <SH221COMMIT>. Doc docs/fp16-decode-gap.md (RESOLVED banner). +1 hermetic (sh221, elfjit example 69/0). Workspace green (arm64jit + elfjit + all crates).
