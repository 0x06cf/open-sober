...
## SH199 (Sep 16, 2026, hermes-worker): WORLD-BUILD FN 0x102ea3b14 GATE BYTE LOCATED + SEEDED (latent-but-correct reachability negative). Commit (pending). Doc docs/frontier-sh199-worldbuild-gate.md, repro runs/capture_sh199_worldbuild.sh. Workspace green (561/0, +1 hermetic; arm64jit 383/0).
