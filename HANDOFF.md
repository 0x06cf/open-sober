...
## SH117 (Sep 14, 2026, hermes-worker): nativeInit flag-map probe helper leaf-rewrite → nativeGameGlobalInit RETURNS + the FULL rung ladder runs (opt-in JIT_SH115_SINGLETON_PATCH=1). Default unregressed; workspace green.
