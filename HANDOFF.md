...
## SH236 (Sep 17, 2026, hermes-worker): StartLuaAppDM's receiveCall dispatch MEASURED soft-returning before the marshaler — block-entry-definitive. +1 hermetic (sh236, elfjit example 81/0). Doc docs/frontier-sh236-sladm-dispatch-softreturn-pinned.md, repro runs/capture_sh236_sladm_marshaler_unreached.sh. Workspace green.
