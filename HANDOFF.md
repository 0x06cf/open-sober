...
## SH197 (Sep 16, 2026, hermes-worker): JIT_REGION_WATCH MULTI-RANGE FIX + do-init continuation chain EXECUTES real code headlessly at HEAD. Commit 9e3386e. Doc docs/frontier-sh197-doinit-continuation-exec.md, repro runs/capture_sh197_continuation.sh. Workspace green (559/0, +1 hermetic).
