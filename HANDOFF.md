...
## SH235 (Sep 17, 2026, hermes-worker): genuine EC DM-creation world's SOLE entry pinned via full-.text caller proof — 9-arg marshaler 0x1023f1210 is the only headless front-door to 0x102e24598. Commit 4a66afd. Doc docs/frontier-sh235-ec-world-sole-entry.md. +1 hermetic (sh235, elfjit example 80/0). Workspace green.
