...
## SH120 (Sep 14, 2026, hermes-worker): app-bridge dispatcher-node data seed clears the SendAppEventOnAppReady [*x1-24] SIGSEGV. Opt-in ladder reaches setTaskSchedulerBM. Default unchanged (run-variable SH55/64 flake, NOT a regression).
